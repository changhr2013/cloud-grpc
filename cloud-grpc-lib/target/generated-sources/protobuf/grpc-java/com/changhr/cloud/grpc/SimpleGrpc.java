package com.changhr.cloud.grpc;
...
public final class SimpleGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.changhr.cloud.grpc.HelloRequest,
      com.changhr.cloud.grpc.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.changhr.cloud.grpc.HelloRequest.class,
      responseType = com.changhr.cloud.grpc.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.changhr.cloud.grpc.HelloRequest,
      com.changhr.cloud.grpc.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.changhr.cloud.grpc.HelloRequest, com.changhr.cloud.grpc.HelloReply> getSayHelloMethod;
      ...
      synchronized (SimpleGrpc.class) {
        if ((getSayHelloMethod = SimpleGrpc.getSayHelloMethod) == null) {
          SimpleGrpc.getSayHelloMethod = getSayHelloMethod = 
              io.grpc.MethodDescriptor.<com.changhr.cloud.grpc.HelloRequest, com.changhr.cloud.grpc.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "Simple", "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.changhr.cloud.grpc.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.changhr.cloud.grpc.HelloReply.getDefaultInstance()))
  ...
  public static abstract class SimpleImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(com.changhr.cloud.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<com.changhr.cloud.grpc.HelloReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.changhr.cloud.grpc.HelloRequest,
                com.changhr.cloud.grpc.HelloReply>(
  ...
  public static final class SimpleBlockingStub extends io.grpc.stub.AbstractStub<SimpleBlockingStub> {
    ...
    /**
     */
    public com.changhr.cloud.grpc.HelloReply sayHello(com.changhr.cloud.grpc.HelloRequest request) {
  ...
  public static final class SimpleFutureStub extends io.grpc.stub.AbstractStub<SimpleFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.changhr.cloud.grpc.HelloReply> sayHello(
        com.changhr.cloud.grpc.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.changhr.cloud.grpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.changhr.cloud.grpc.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class SimpleBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.changhr.cloud.grpc.HelloWorldProto.getDescriptor();
    }
